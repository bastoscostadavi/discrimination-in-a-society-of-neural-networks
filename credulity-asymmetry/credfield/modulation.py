...
Copied unchanged from the main line of work: the modulation functions belong to
the inference problem and know nothing about classes, so a general
class-dependent field cannot touch them.  It reaches them only through the value
of ``h_w`` it is handed.
