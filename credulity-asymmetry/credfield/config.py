...
of :mod:`credfield.fields` the strength axis of a sweep drives.  This directory
defaults it to ``b``, the credulity asymmetry, and the ``full`` preset is the
resolution the paper's own phase diagram is run at: a 200x200 grid at ``N = 40``.
"""
