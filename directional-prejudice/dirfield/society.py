...
:mod:`dirfield.fields`, rather than one of six tabulated matrices.
...
quantities through the modulation functions of :mod:`dirfield.modulation`:
...
class SocietyBatch:
    ...
    a, b, c, p
        ...
        ``R``.  See :mod:`dirfield.fields`; ``p`` alone reproduces the main line
