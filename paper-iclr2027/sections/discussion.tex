...
not depend on $\hw$.\llmtodo{the direct ablation is not run; see NOTES.md} What
...
clean version of a case that is never clean in practice. And the map from an
instruction given to a language agent to a numerical $d$ is a calibration, not an
identity: \S\ref{sec:llm} tests whether the structure transfers, not whether the
two systems agree quantitatively. Extending any of this to human societies is a
further step the model does not license.
