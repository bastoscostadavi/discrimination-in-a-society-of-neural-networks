...
\begin{figure}[t!]
  ...
  (IIIa), discrimination aligns both trust and opinion with class; in (IIIb),
  discrimination aligns trust with class but not opinion. Right: one population
  from each state. Each arrow is an
...
The perceptron is an effective linear opinion readout and can act on representations
